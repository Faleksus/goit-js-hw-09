...
const options = {
    ...
    onClose (selectedDates) {
        ...
        if (dateNow > selectedDate) return (0, _notiflixDefault.default).Notify.failure("Please choose a date in the future");
        startBtn.disabled = false;
        startBtn.addEventListener("click", onBtnStartElClick);
    }
};
(0, _flatpickrDefault.default)(inputEl, options);
...
const timerEl = {
    ...
    start () {
        ...
        this.intervalId = setInterval(()=>{
            ...
            if (deltaTime <= 2000) return clearInterval(this.intervalId);
...
},{}],"eVN6V":[function() {},{}]},["8NMcg","1AWyZ"], "1AWyZ", "parcelRequire7bc7")
